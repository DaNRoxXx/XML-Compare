...
namespace VisualXmlDiff
{
	...
	public class VisualXmlDiff : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.button3.Location = new System.Drawing.Point(218, 70);
            ...
            this.Text = "XML Compare - TPS - Danish Rehan";
		...
		public void DoCompare(string file1, string file2)
		{
			...
			string tempFile = startupPath + Path.DirectorySeparatorChar + "Config Difference - " + r++ + ".htm";
			StreamWriter sw1 = new StreamWriter( tempFile );
			

			sw1.Write("<html><body><table width='100%'>" +
                "<h1 style='display: inline'><font color='blue'>XML Compare</font></h1>" +
                "&nbsp;<h3 style='display: inline'><font color='#AAAAAA'>by Danish Rehan</font></h3>");
			//Write Legend.
			sw1.Write("<tr><td colspan='2' align='left'><b><font color='blue'>Legend:</font></b><font style='background-color: yellow'" + 
			...
			sw1.Write("<tr><td><font color='blue'><b> File Name : </font>");
			sw1.Write(textBox1.Text);
			sw1.Write("</b></td><td><font color='blue'><b> File Name : </font>");
			...
			sw1.Write("</table>" +
                "<footer><p><font color='#AAAAAA'>Tool developed by: Danish Rehan<br />Contact information: </font>" +
                "<a href = 'mailto:danish.rehan@tpsonline.com?subject=XML%20Compare'> " +
                "danish.rehan@tpsonline.com</a>.</p></footer> " +
                "</body></html>");
